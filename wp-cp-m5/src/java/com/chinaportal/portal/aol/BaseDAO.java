...
public abstract class BaseDAO
{
    ...
    protected abstract Object doExecute( Class c, Serializable pk ) throws ObjectNotFoundException, HibernateException,
            SQLException;
    ...
    protected void rollback() throws DAOException
    {
        try
        {
            ...
            if ( session != null && !session.connection().getAutoCommit() )
            {
