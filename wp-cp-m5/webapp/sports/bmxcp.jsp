...
<div class="sports_box">
	...
	<div class="content">
    	...
    	<script language="javascript">
    		boxTitle         = "2005 UCI BMX <bean:message key="label.world" bundle="sports"/><bean:message key="label.prize_match" bundle="sports"/>";
    		boxTitleUrl      = "";
    		boxRightTitle    = "";
    		boxRightTitleUrl = "";
    	</script>
		...
		<div class="content">
			<iframe id="bmx" frameborder="0" scrolling="no" height="1000" width="100%" src="http://www.mediazone.com/channel/bmx/chinese/index.jsp"></iframe>
		</div>
