	...
	<div class="content">
		...
		<div class="block_header" style="width:100%;height:20px;background: url(<%=themesPath%>icons/icon_neilandi.jpg);">
		    ...
		    <div style="float:left;padding-top:4px;">
		    	...
		    	<bean:message key="header.wttc" bundle="sports"/>
		    </div>
		    <div style="float:right;"><img src="<%=themesPath%>icons/icon_neilanjiao01.jpg" border="0"></div>
		</div>
 	
		<div class="content" style="background: url(<%=langImagePath%>banner_typp_l.jpg);width:610px;height:257px;">
			<div class="introduction">
				<b>ChinaPortal<bean:message key="header.wttc" bundle="sports"/><bean:message key="label.all_match" bundle="sports"/>:</b>
...
<% if( ! currentSiteName.equals("japan") ) { %>
					<button onclick="subscribePack('6')"><bean:message key="button.subscribe" bundle="sports"/><bean:message key="label.all_match" bundle="sports"/></button>
<% } %>
				</div>
			</div>
			...
			<!-- div style="float:right;text-align:right;width:40%;margin-top:20px;margin-right:5px;">
				<a href="sports/team_list.php?itemid=id" style="text-decoration: underline;"><bean:message key="label.teams_detail" bundle="sports"/></a>
			</div -->
		</div>
...
<% } %>
	...
	<div class="content">
		...
		<div class="block_header" style="width:100%;height:20px;background: url(<%=themesPath%>icons/icon_neihuangdi.jpg);">
            ...
            <div style="float:left;padding-top:2px;">&nbsp;<bean:message key="header.wttc" bundle="sports"/><bean:message key="label.all_match" bundle="sports"/></div>
