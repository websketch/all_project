	...
	<div class="content">
		...
		<div class="block_header" style="width:100%;height:20px;background: url(<%=themesPath%>icons/icon_neilandi.jpg);">
		    ...
		    <div style="float:left;padding-top:4px;">
		    	...
		    	<bean:message key="title.sports" bundle="sports"/></a><span style="font-family:'宋体'">-></span>
		    	<bean:message key="header.csll" bundle="sports"/>
			</div>
		    <div style="float:right;"><img src="<%=themesPath%>icons/icon_neilanjiao01.jpg" border="0"></div>
		</div>
 	
		<div class="content" style="background: url(<%=langImagePath%>banner_tyzclsb_l.jpg);width:610px;height:257px;">
			<div class="introduction">
				<b>ChinaPortal<bean:message key="header.csll" bundle="sports"/><bean:message key="label.all_match" bundle="sports"/>:</b>
				<li><bean:message key="label.introduction_1" bundle="sports"/><b><bean:message key="label.introduction_2" bundle="sports"/></b></li>
				<li><bean:message key="label.introduction_8" bundle="sports"/></li>
...
<% if( ! currentSiteName.equals("japan") ) { %>
					<button onclick="subscribePack('10')"><bean:message key="button.subscribe" bundle="sports"/><bean:message key="label.all_match" bundle="sports"/></button>
<% } %>
				</div>
			</div>
