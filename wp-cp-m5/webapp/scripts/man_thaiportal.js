//$Id: man_thaiportal.js,v 1.1.2.5 2005/12/05 11:50:07 ganquan Exp $
...
//for thaiportal package.
	...
	case "102": //ThaiYearPack  Package
		...
		break;	
	case "103": //ThaiQuarterlyPack  Package
		url = selfcareHost + "/common/index.asp?crmid=" + crmid + "&action=authorize&aid=" + aid + "&iid=QuarterlyPack&returnurl=" + escape(subscribePackReturnUrl);
		break;	
