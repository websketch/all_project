...
<tr>
	<td colspan="5" background="<%=themesPath%>icons/icon_neihuangdi.jpg" width="100%">
		...
		<tr>
			...
			<td align="left"><div style="padding-top:3px;"><bean:message key="title.news_entertainment"/></div></td>
...
%>
	<%
		...
		linkURI=request.getContextPath()+"/content/news/news_view_sports.jsp?news_id="+news_id;
		}else{
	  linkURI = request.getContextPath()+"/content/news/news_view.jsp?news_id="+news_id;
	  }
	%>  
...
<%}else{%>
 <div class="news_list">
	...
	<br><center>Sorry, English and Thai version is not available for Entertainment News.</center><br>
