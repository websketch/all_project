...
<% if( ! currentSiteName.equals("thaiportal") ) { %>
	...
	<div style="background:url(<%=themesPath%>images/icons_newsubscibe_zlt.jpg) repeat-y">
		<div style="float:left;"><img src="<%=themesPath%>images/icons_newsubscibe_slt.jpg"/></div>
		<div style="height:260px;_height:160px;padding:0 30px 0 30px;">
			<img src="<%=langImagePath%>banner_newsubscibe_crpdhy.jpg"/>
			<div style="float:left;width:250px;">
				<ul>
					<li>More than 300 hot Japanese, Korean, European and American movies</li>
					<li>High quality video image; watch favorite programs whenever and wherever you’d decide</li>
					<li>Viewing at maximum 2 PCs per account</li>
					<li>Available only out of Mainland China </li>
				</ul>
			</div>
